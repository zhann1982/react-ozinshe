...
import styles from '@css/ModalAddToMainProjects.module.css'
import TimesIcon from '@icons/TimesIcon';
import DropDownSelect from '@components/DropDownSelect'
import DragAndDropUploader from '@components/DragAndDropUploader'
import {filmCards} from '@services/filmCardBase'

const ModalAddToMainProjects = ({ isOpen, onClose, confirmAddToMainProjects,title }) => {
...
export default ModalAddToMainProjects